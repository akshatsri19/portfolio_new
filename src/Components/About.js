...
const About = () => {
    ...
    useEffect(() => {
        const observer = new IntersectionObserver(
            ...
            { threshold: 1 } // Trigger animation when 20% of the section is visible
        );
    ...
    return (
        ...
        <section 
        className="about-section bg-black text-gray-400 py-4 pb-20 px-2 md:px-12 lg:px-20 text-center" >
                    ...
                    <div className="grid grid-cols-1 gap-8 mt-6 text-left">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-bold mb-2">
                                ...
                                <span className="font-normal">
                                    REST APIs, GCP, CI/CD Pipelines, Agile Methodologies, Web3.js, HTML, CSS, Hardhat
                                </span>
                            </p>
                        </div>
                    </div>
